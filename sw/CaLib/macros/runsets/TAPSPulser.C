...
void CheckPulsers(const Char_t* loc)
{
    ...
    for (Int_t j = 0; j < nCh; j++)
    {
        ...
        g->SetName(t);
        g->SetTitle(t);
        g->GetYaxis()->SetRangeUser(800, 1000);
...
void TAPSPulser()
{
    ...
    const Char_t calibration[] = "LH2_Oct_14";
    const Char_t* fLoc = "/scratch/werthm";
    //const Char_t* fAR = "/usr/users/werthm/AcquRoot/acqu/acqu/data/May_09/TAPS/BaF2_PWO.dat";
    const Char_t* fAR = "/home/werthm/src/ROOT/acqu/acqu_user/data/Oct_14/TAPS/Veto.dat";
