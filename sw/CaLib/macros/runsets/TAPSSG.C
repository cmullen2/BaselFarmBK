...
void CheckEnergy(const Char_t* loc)
{
    ...
    for (Int_t i = 0; i < nRuns; i++)
    {
        ...
        for (Int_t j = 0; j < nCh; j++)
        {
            ...
            //    func->SetParLimits(0, 0, 1000);https://legacy.campus.gla.ac.uk/owa/auth/logon.aspx?url=https://legacy.campus.gla.ac.uk/owa/%3Fae=Folder%26t=IPF.Note%26id=LgAAAACK3DlXDjkeSJLqtZFOhXvWAQCkiSDduzz%252fRrng7b7HgOi%252fADaMTJNTAAAB%26slUsng=0&reason=3
...
void TAPSSG()
{
  ...
  //  const Char_t* fLoc = "/w/work14/werthm/A2/Jul_14/presort/data/00";
    ...
    const Char_t calibration[] = "D-Butanol_May_16";
    //const Char_t* fLoc = "/usr/puma_scratch0/werthm/A2/May_09/AR/out/ADC";
    const Char_t* fLoc = "/usr/panther_scratch0/mullen/AR/May_16";
